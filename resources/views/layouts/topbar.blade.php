        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}"
                    alt="Header Avatar">
                <span class="d-none d-xl-inline-block ms-1" key="t-henry">{{isset(Auth::user()->name) ? ucfirst(Auth::user()->name) : 'Guest'}}</span>
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                {{-- <form id="logout-form" action="{{ route('index') }}" method="POST" style="display: none;">
                    @csrf
                </form> --}}
            </div>
        </div>
